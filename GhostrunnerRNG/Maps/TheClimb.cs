...
namespace GhostrunnerRNG.Maps {
    class TheClimb : MapCore {
        ...
        protected override void Gen_PerRoom() {
            ...
            EnemyShieldOrb shieldOrb1 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x20, 0x128, 0xA8, 0x1D8, 0x6C0, 0x130, 0x1D0));
            ...
            shieldOrb1 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x20, 0x128, 0xA8, 0x1E8, 0x6C0, 0x130, 0x1D0));    // shield obj +  orb glow ptr
            ...
            shieldOrb1 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x20, 0x128, 0xA8, 0x1E0, 0x6C0, 0x130, 0x1D0));
            ...
            shieldOrb1 = new EnemyShieldOrb(enemies[1], new DeepPointer(0x045A3C20, 0x98, 0x28, 0x128, 0xA8, 0xC8, 0x6C0, 0x130, 0x1D0));

            EnemyShieldOrb shieldOrb2 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x28, 0x128, 0xA8, 0xD0, 0x6C0, 0x130, 0x1D0));
            ...
            shieldOrb1 = new EnemyShieldOrb(enemies[1], new DeepPointer(0x045A3C20, 0x98, 0x30, 0x128, 0xA8, 0x1D8, 0x6C0, 0x130, 0x1D0));
            ...
            shieldOrb2 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x30, 0x128, 0xA8, 0x1E0, 0x6C0, 0x130, 0x1D0));
        ...
        public void Gen_PerRoom_AfterCV() {
            ...
            EnemyShieldOrb shieldOrb1 = new EnemyShieldOrb(enemies[1], new DeepPointer(0x045A3C20, 0x98, 0x40, 0x128, 0xA8, 0x270, 0x6C0, 0x130, 0x1D0));
            ...
            EnemyShieldOrb shieldOrb2 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x40, 0x128, 0xA8, 0x278, 0x6C0, 0x130, 0x1D0));
            ...
            shieldOrb1 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x48, 0x128, 0xA8, 0x110, 0x6C0, 0x130, 0x1D0));

            shieldOrb2 = new EnemyShieldOrb(enemies[1], new DeepPointer(0x045A3C20, 0x98, 0x48, 0x128, 0xA8, 0x108, 0x6C0, 0x130, 0x1D0));
            ...
            layout = new RoomLayout(enemies[2], enemies[3] , enemies[4], enemies[5], enemies[6]);  // pistols
            // main sections
            ...
            shieldOrb1 = new EnemyShieldOrb(enemies[0], new DeepPointer(0x045A3C20, 0x98, 0x8, 0x128, 0xA8, 0x98, 0x6C0, 0x130, 0x1D0));
            shieldOrb2 = new EnemyShieldOrb(enemies[1], new DeepPointer(0x045A3C20, 0x98, 0x8, 0x128, 0xA8, 0x90, 0x6C0, 0x130, 0x1D0));
            ...
            EnemyShieldOrb shieldOrb3 = new EnemyShieldOrb(enemies[2], new DeepPointer(0x045A3C20, 0x98, 0x8, 0x128, 0xA8, 0x88, 0x6C0, 0x130, 0x1D0));
